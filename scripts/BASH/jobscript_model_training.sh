...
oarsub -S -n ${mod_size}_${TS_opt}_${norm_method}_noisf${isf_out}_notblock${tblock_out} --stdout ${mod_size}_${TS_opt}_${norm_method}_noisf${isf_out}_notblock${tblock_out}.o%jobid%  --stderr ${mod_size}_${TS_opt}_${norm_method}_noisf${isf_out}_notblock${tblock_out}.e%jobid% -l nodes=1/core=2,walltime=10:00:00 --project ice_speed -p "network_address='luke62'" $path_jobscripts/${mod_size}_${TS_opt}_${norm_method}_noisf${isf_out}_notblock${tblock_out}.sh
