...
layer_nb=3 #'mini', 'small', 'medium', 'large', 'extra_large' # still need L and XL for both CV
layer_size=256
...
oarsub -S -n ${layer_nb}_${layer_size}_${TS_opt}_${norm_method}_noisf${isf_out}_notblock${tblock_out}_${exp_name} --stdout $path_jobid/${layer_nb}_${layer_size}_${TS_opt}_${norm_method}_noisf${isf_out}_notblock${tblock_out}_${exp_name}.o%jobid%  --stderr $path_jobid/${layer_nb}_${layer_size}_${TS_opt}_${norm_method}_noisf${isf_out}_notblock${tblock_out}_${exp_name}.e%jobid% -l /nodes=1/gpu=1,walltime=03:00:00 --project mais -p "gpumodel='A100'" $path_jobscripts/${layer_nb}_${layer_size}_${TS_opt}_${norm_method}_noisf${isf_out}_notblock${tblock_out}_${exp_name}.sh
