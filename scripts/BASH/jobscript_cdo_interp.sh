...
path_outfiles=/bettik/burgardc/SCRIPTS/basal_melt_param/scripts/BASH/JOB_SCRIPTS/
...
oarsub -S -n ${nemo_run}_${i} --stdout $path_jobid/${nemo_run}_${i}.o%jobid%  --stderr $path_jobid/${nemo_run}_${i}.e%jobid% -l nodes=1/core=2,walltime=10:00:00 --project ice_speed -p "network_address='luke62'" $path_jobscripts/${nemo_run}_${i}.sh
