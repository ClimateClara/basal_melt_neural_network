...
TS_opt=extrap_shuffboth # extrap, whole, thermocline #extrap_shuffboth
...
cat <<EOF > $path_jobscripts/shuffling2D_${vv}_ensmean_${mod_size}_${TS_opt}_${norm_method}_${exp_name}_${nemo_run}.sh 

#!/bin/bash

conda activate neuralnet
python -u $path_python/compute_2D_evalmetrics_shuffling_deepensemble_Smith.py ${mod_size} ${TS_opt} ${norm_method} ${exp_name} ${nemo_run} ${vv} 2>&1 | tee $path_outfiles/shuffling2D_${vv}_ensmean_${mod_size}_${TS_opt}_${norm_method}_${exp_name}_${nemo_run}.log
EOF

chmod +x $path_jobscripts/shuffling2D_${vv}_ensmean_${mod_size}_${TS_opt}_${norm_method}_${exp_name}_${nemo_run}.sh

oarsub -S -n shuffling2D_${vv}_ensmean_${mod_size}_${TS_opt}_${norm_method}_${exp_name}_${nemo_run} --stdout $path_jobid/shuffling2D_${vv}_ensmean_${mod_size}_${TS_opt}_${norm_method}_${exp_name}_${nemo_run}.o%jobid%  --stderr $path_jobid/shuffling2D_${vv}_ensmean_${mod_size}_${TS_opt}_${norm_method}_${exp_name}_${nemo_run}.e%jobid% -l nodes=1/core=3,walltime=08:00:00 --project mais -p "network_address='luke62'" $path_jobscripts/shuffling2D_${vv}_ensmean_${mod_size}_${TS_opt}_${norm_method}_${exp_name}_${nemo_run}.sh
