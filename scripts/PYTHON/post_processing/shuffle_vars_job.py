...
nemo_run0 = 'OPM027' #['OPM006', 'OPM016', 'OPM018', 'OPM021', 'OPM026', 'OPM027', 'OPM031-1', OPM031-2']
...
T_list = ['T_001', 'T_002',
               ...
               'T_059', 'T_060', 'T_061', 'T_062', 'T_063', 'T_064', 'T_065',
               'T_066', 'T_067', 'T_068']
S_list = ['S_001', 'S_002', 'S_003', 'S_004',
               'S_005', 'S_006', 'S_007', 'S_008', 'S_009', 'S_010', 'S_011',
               'S_012', 'S_013', 'S_014', 'S_015', 'S_016', 'S_017', 'S_018',
               'S_019', 'S_020', 'S_021', 'S_022', 'S_023', 'S_024', 'S_025',
               'S_026', 'S_027', 'S_028', 'S_029', 'S_030', 'S_031', 'S_032',
...
single_prof_steps = False

if timetag == '20220427-1051':
    
    if single_prof_steps:
...
for shuff_var in var_list:
    ...
    for kisf in isf_list: 
        ...
        elif shuff_var == 'T_profiles':
            shuffled_df = new_df[T_list].copy().sample(frac=1, random_state=1)
            for TT in T_list:
                new_df[TT] = shuffled_df[TT].values
                new_df[TT] = shuffled_df[TT].values
        elif shuff_var == 'S_profiles':
            shuffled_df = new_df[S_list].copy().sample(frac=1, random_state=1)
            for SS in S_list:
                new_df[SS] = shuffled_df[SS].values
                new_df[SS] = shuffled_df[SS].values
        else:
